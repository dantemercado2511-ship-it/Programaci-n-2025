...
class Microsatelite:
    ...
    def Calcular_Momento_Angular_Total(self):
        ...
        hT_x = -self.cmgs[0].h * np.sin(self.cmgs[0].aangulo) + self.cmgs[1].h * np.sin(self.cmgs[1].angulo) + self.cmgs[4].h * np.cos(self.cmgs[4].angulo) - self.cmgs[5].h * np.cos(self.cmgs[5].angulo)
...
def Actualizar(frame):
    ...
    ax.quiver(0, 0, 0, microsatelite.orientacion[0], microsatelite.orientacion[1], microsatelite.orientacion[2], length=0.5, color='darkorchid', linewidth=2, arrow_length_ratio=0.1)
